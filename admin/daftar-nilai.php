                    ...
                    <?php 
                            ...
                            if(isset($_POST['send'])) {
                                if(nilai($_POST) > 0) {
                                    echo "
                                        <script>
                                        alert('Data Nilai Terkirim')
                                        document.location.href= 'daftar-nilai.php'
                                        </script>";
                                }else {
                                    echo "<script>
                                    alert('Data Nilai Tidak Terkirim')
                                    document.location.href= 'daftar-nilai.php'
                                    </script>";
                                }
                            }
                    
                        $query = mysqli_query($conn, "SELECT * FROM nilai INNER JOIN mahasiswas
                                                        ON nilai.nim = mahasiswas.nim JOIN mata_kuliah ON 
                                                        nilai.id_matkul = mata_kuliah.id_matkul LIMIT $halaman_awal, $batas");
                        ...
                        <div class="modal fade" id="myModal">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header" style="background-color:pink;">
                                    <h4 class="modal-title" style="color:black;">Tambah Data Nilai</h4>
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST">
                                        ...
                                        <select class="form-select" name="nilai" id="nilai" aria-label="Default select example">
                                            ...
                                            <option class="text-muted" value="4">A</option>
                                            <option class="text-muted" value="3">B</option>
                                            <option class="text-muted" value="3">C</option>
                                            <option class="text-muted" value="1">D</option>
                                        </select>
                                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                    ...
                                                    <a href="action/updatenilai.php?id=<?= $data['id_nilai']; ?>" type="button" class="btn btn-outline-success">
                                            ...
                                            <td>
                                                    <a href="action/deletenilai.php?id=<?= $data['id_nilai']; ?>" type="button" class="btn btn-outline-danger">
