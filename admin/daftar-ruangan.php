            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-grey-1000">Daftar Ruangan</h1>
                    </div>
                                        ...
                                        <?php
                                                        ...
                                                        if(isset($_POST['send'])) {
                                                            ...
                                                            if (ruang($_POST) > 0) {
                                                                echo "
                                                                    <script>
                                                                    alert('Data Ruangan Terkirim')
                                                                    document.location.href = 'daftar-ruangan.php'
                                                                    </script>";
                                                            } else {
                                                                echo "
                                                                    <script>
                                                                        alert('Data Ruangan Tidak Terkirim')
                                                                    </script>";
                                                            }
                                                        }

                                            $query2 = mysqli_query($conn, "SELECT * FROM ruangan INNER JOIN dosen ON ruangan.id_dosen =
                                                                                                dosen.id_dosen LIMIT $halaman_awal, $batas");
                        ...
                        <div class="modal fade" id="myModal">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header" style="background-color:pink;">
                                    <h4 class="modal-title" style="color:black;">Tambah Data Ruangan</h4>
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST">
                                        <div class="mb-3">
                                            <input type="text" name="nama_ruangan" placeholder="Masukkan Nama Ruangan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <td>
                                        ...
                                        <a href="action/updateruang.php?id=<?= $data['id_ruangan']; ?>" type="button" class="btn btn-outline-success">
                                ...
                                <td>
                                        <a href="action/deleteruang.php?id=<?= $data['id_ruangan']; ?>" type="button" class="btn btn-outline-danger">
