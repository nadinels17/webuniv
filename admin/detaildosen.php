        ...
        <div id="content-wrapper" class="d-flex flex-column vh-100 overflow-y-auto">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="datadosen.php" style="color:pink;"> 
                    ...
                    $dosen = $_GET['id'];
                    $qry = mysqli_query($conn, "SELECT * FROM dosen INNER JOIN mata_kuliah ON 
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <img width="400px" src="img/imgdosen/<?= $data['foto_dosen']; ?>" class="prof-img">
                                </div>

                                <div class="col">
                                    <h2 style="margin-left: -80px;">Id Dosen : <?=$data['id_dosen'];?> </h2>

                                    <br>

                                    <h2 style="margin-left: -80px;">Nama : <?=$data['nama_dosen'];?> </h2>

                                    <br>

                                    <h2 style="margin-left: -80px;">Mata Kuliah Yang diajar : <?=$data['nama_matkul'];?> </h2>
