        ...
        <div id="content-wrapper" class="d-flex flex-column vh-100 overflow-y-auto">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="index.php" style="color:pink;"> 
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <img src="../admin/img/imgmhs/<?=$_SESSION['fotomhs'];?>" width="350px" alt=""> 
                                </div>

                                <div class="col mx-2">
                                    <h2 style="margin-left: -80px;">Nama Mahasiswa : <?=$_SESSION['nama_mhs'];?> </h2>
                                    <h2 style="margin-left: -80px;">NIM : <?=$_SESSION['nim'];?> </h2>
                                    <h2 style="margin-left: -80px;">Semester : <?=$_SESSION['semester'];?> </h2>
                                </div>
